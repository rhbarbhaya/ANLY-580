...
digspan ~~ 16.54232*digspan
matrixreason ~~ 6.128749*matrixreason
piccomp ~~ 4.870985*piccomp
arith ~~ 8.929757*arith
compreh ~~ 13.86779*compreh
simil ~~ 7.818606*simil
vocab ~~ 44.0789*vocab
block ~~ 53.90284*block
inform ~~ 18.56018*inform
symbolsearch ~~ 14.18153*symbolsearch
'
bifactor.fit = cfa(bifactor, data = data2, check.gradient = F)
inspect(bifactor.fit, "cov.lv")
inspect(bifactor.fit, "cor.lv")
# summary(bifactor.fit, standardized = T)
```
